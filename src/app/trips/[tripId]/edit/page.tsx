...
export default function EditTripPage({ params }: TripPageProps) {
  ...
  const fetchTrip = async () => {
    ...
    try {
      ...
      if (trip.cover_photo_url) {
        setPreviewUrl(trip.cover_photo_url);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Failed to update trip. Please try again."
      );
    } finally {
      setSaving(false);
    }
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                You may not have permission to edit this trip.
              </p>
              <Link
                href={`/trips/${tripId}`}
